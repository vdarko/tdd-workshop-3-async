...
public class UnsynchedCounterTest {

  private static final int THREAD_COUNT = 8;

  /**
   * <b>GIVEN</b> unsynched counter</br>
   * <b>AND</b> counter invokers</br>
   * <b>WHEN</b> counter invokers are invoking unsynched counter using
   * {@value #THREAD_COUNT} threads for 1 second</br>
   * <b>THEN</b> counter is <b>not</b> incremented correctly since it is not synched</br>
   * <b>AND</b> actual and expected counter invoked count has a huge
   * difference</br>
   */
  @Test
  public void testNotSynchedHugeDifference() throws Exception {
    ...
    Counter counter = new UnsynchedCounter();
    ...
    assertThat(actualCounterInvocations).isNotCloseTo(expectedCounterInvocations, Offset.offset(1_000_000));
  }
}
